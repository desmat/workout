...
export const sampleExercises: Exercise[] = [
  {
    ...
    "instructions": "Start in a plank position with your hands slightly wider than your shoulders. Keep your body straight and lower it to the ground by bending your elbows. Push back up to the starting position.",
    "variations": [
      {
        "name": "Knee Push Up",
        "level": "Beginner",
        "description": "A simpler version of the standard push up, ideal for beginners.",
        "instructions": "Start in a plank position but with your knees on the ground. Lower your upper body to the ground by bending your elbows and then push back up."
      },
      {
