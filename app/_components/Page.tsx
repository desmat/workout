...
export default function Page({
  ...
  return (
    <main className={`relative flex flex-col items-left _lg: max-w-4xl _lg: mx-auto _px-4 min-h-[calc(100dvh-2.5rem)] lg:min-h-[calc(100dvh+0rem)] lg:pb-4${className ? " " + className : ""}`}>
      {loading &&
